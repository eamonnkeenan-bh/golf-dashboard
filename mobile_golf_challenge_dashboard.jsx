...
/*
  GolfChallengeDashboard (pure JSX)
  - This version removes all TypeScript syntax so it works in plain .jsx projects on GitHub.
  - Tailwind classes are included; ensure your repo has Tailwind set up (or replace classes with CSS).
  - Logo now uses a public URL so it renders on GitHub Pages/previewers.
*/

const BH_BRAND = { green: "#24765d", navy: "#0b1d30" };
const BH_LOGO_SRC = "https://bettinghero.com/wp-content/uploads/cropped-Primary-Wordmark_Light-BG-1.webp";

const ENTRY_FEE = 50;
const PAYOUTS = { 1: 5000, 2: 1000, 3: 250 };

// Data model fields (JS-only): id, name, course, date (YYYY-MM-DD), distance (ft), type ("closest" | "putt" | "drive")
const sampleData = [
    ...
    <div className="min-h-screen w-full bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90">
        <div className="mx-auto max-w-5xl px-4 py-3 flex items-center gap-3">
          <img src={BH_LOGO_SRC} alt="Betting Hero" className="h-12 w-auto object-contain" />
      ...
      <footer className="mx-auto max-w-5xl px-4 py-8 text-center text-xs text-slate-500">
        <img src={BH_LOGO_SRC} alt="Betting Hero" className="h-6 w-auto mx-auto mb-2" />
